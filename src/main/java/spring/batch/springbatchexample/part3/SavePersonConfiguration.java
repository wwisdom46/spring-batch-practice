...
/**
 * CSV 파일 데이터를 읽고 MYSQL DB에 insert 하는 예제
 */
@Configuration
@Slf4j
public class SavePersonConfiguration {
    ...
    public Job savePersonJob() throws Exception {
        return this.jobBuilderFactory.get("savePersonJob")
                ...
                .listener(new SavePersonListener.SavePersonAnnotationJobExecutionListner())
                .build();
    }
    ...
    private ItemWriter<? super Person> itemWriter() throws Exception {
        //return items -> items.forEach(x -> log.info("I'm {}", x.getName()));
